...
import 'schema/talents_record.dart';
...
export 'schema/talents_record.dart';
...
/// Functions to query TalentsRecords (as a Stream and as a Future).
Future<int> queryTalentsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      TalentsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<TalentsRecord>> queryTalentsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      TalentsRecord.collection,
      TalentsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<TalentsRecord>> queryTalentsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
