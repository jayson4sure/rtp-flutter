...
class CreateCandidateWidget extends StatefulWidget {
  const CreateCandidateWidget({super.key});
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      'Input candidate\'s information below',
                                                ...
                                                return Padding(
                                                  padding:
                                                      MediaQuery.viewInsetsOf(
                                                          context),
                                                  child: const JobRolesListWidget(),
                                                );
                                              },
                                            ).then((value) => safeSetState(() =>
                                                _model.selectecJobRole =
                                                    value));
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await TalentsRecord.collection.doc().set({
                                ...createTalentsRecordData(
                                  ...
                                  jobRoleRef: _model.selectecJobRole?.reference,
                                  status: 'Unassigned',
                                  phone: _model.yourNameTextController4.text,
                                  email: _model.yourNameTextController3.text,
                                  cvLink: _model.yourNameTextController5.text,
                                  photoUrl: _model.uploadedFileUrl,
                                  videoLink:
                                      _model.yourNameTextController6.text,
                                ),
                                ...mapToFirestore(
                                  {
