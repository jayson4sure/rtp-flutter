...
import 'create_client_model.dart';
export 'create_client_model.dart';

class CreateClientWidget extends StatefulWidget {
  const CreateClientWidget({super.key});
...
class _CreateClientWidgetState extends State<CreateClientWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateClientModel());
    ...
    _model.passwordTextController ??= TextEditingController(text: 'temppass');
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      'Input client\'s information below',
                            ...
                            onPressed: () async {
                              ...
                              await clientsRecordReference.set({
                                ...createClientsRecordData(
                                  ...
                                  lastname: _model.yourNameTextController2.text,
                              ...
                              _model.createUserWithoutLoginReturn =
                                  await actions.createUserWithoutLogin(
                                _model.yourNameTextController3.text,
                                _model.passwordTextController.text,
                                '${_model.yourNameTextController1.text} ${_model.yourNameTextController2.text}',
                                _model.createdClient!.reference.id,
                              );
                              context.safePop();
